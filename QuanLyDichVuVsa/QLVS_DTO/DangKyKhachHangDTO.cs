...
namespace QLVS_DTO
{
    public class DangKyKhachHangDTO
    {
        ...
        public DangKyKhachHangDTO(string maKH, string hoTen, string gioiTinh, DateTime ngaySinh, string sDT, string email, string maQG, string soHoChieu, byte[] passport, byte[] avatar)
        {
            this.MaKH = maKH;
            this.HoTen = hoTen;
